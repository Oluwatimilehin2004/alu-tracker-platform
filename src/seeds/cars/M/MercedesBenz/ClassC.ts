...
import c63AmgDtm from '@/seeds/cars/M/MercedesBenz/C/c63AmgDtm.json';

export default [amgGtS, twentyTwentyTwoShowcarVisionAmg, clkGtr, amgGtBlackSeries, c63AmgDtm];