...
import zondaR from '@/seeds/cars/P/Pagani/A/zondaR.json';
import zondaCinque from '@/seeds/cars/P/Pagani/A/zondaCinque.json';

export default [huayraBC, imola, utopiaCoupe, zondaHPBarchetta, zondaR, zondaCinque];